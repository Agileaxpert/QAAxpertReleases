...
<head id="Head1" runat="server">
    ...
    <style>
        ...
        .grdattch.readonly, .nongrdattch.readonly {
        ...
        .dvFgresizer {
            ...
            width: 10px; /* Adjust the width of the resizer */
            position: absolute;
            top: 0;
            right: 0;
            cursor: col-resize;
        ...
        .scrollable-tabs {
            ...
            .tab-slider-container .slider-arrow {
...
<body onload="ChangeDir('<%=direction%>');" id="<%=transId %>" class="content d-flex flex-column flex-column-fluid fs-6 p-0 <%=formLayoutClass%>" dir="<%=direction%>">
            ...
            <div id="heightframe" runat="server">
                <div id="formContainer" class="col-xl-12">
                    <form id="form1" runat="server" enctype="multipart/form-data">
                        ...
                        <asp:HiddenField ID="hdnTstSInfo" runat="server" />
                                            ...
                                            <ContentTemplate>
                                                <div class="d-flex flex-column">
                                                    <div class="tst-search d-flex flex-row-auto gap-5">
                                                        <div id="dvFilterCondition" class="col-md-10 d-flex flex-row-auto gap-1">
                                                            <div class="col-md-5 ">
                                                                <asp:Label ID="lblsrch" runat="server" meta:resourcekey="lblsrch" class="form-label col-form-label pb-1 fw-boldest">Search For</asp:Label>
                                                                <asp:DropDownList ID="ddlSearch" CssClass="form-select" runat="server">
                                                                </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2 ">
                                                                <asp:Label ID="lblwth" runat="server" CssClass="form-label col-form-label pb-1 fw-boldest" meta:resourcekey="lblwth">Mode</asp:Label>
                                                                <asp:DropDownList ID="ddlModeSearch" CssClass="form-select" runat="server">
                                                                    <asp:ListItem Value="Contains" Selected="True">Contains</asp:ListItem>
                                                                    <asp:ListItem Value="Starts with">Starts with</asp:ListItem>
                                                                    <asp:ListItem Value="Ends with">Ends with</asp:ListItem>
                                                                </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-5 ">
                                                                <asp:Label ID="lblsearchvalue" runat="server" CssClass="form-label col-form-label pb-1 fw-boldest required" meta:resourcekey="lblsearchvalue">Value</asp:Label>
                                                        ...
                                                        <div class="col-md-2 d-flex gap-5">
                                                            <div class="col-md-12 pt-6">
                                                                <a id="btnAddFilter" class="btn btn-sm btn-icon btn-active-primary shadow-sm p-5" name="Add Filter" title="Add Filter" href="javascript:void(0)" onclick="javascript:tstSearchFilterRepeat();">
                                                                ...
                                                                <a id="btnViewColumn" class="btn btn-sm btn-icon btn-active-primary shadow-sm p-5" name="View Columns" title="View Columns" href="javascript:void(0)" onclick="javascript:SearchViewColumns();">
