                    ...
                    case "t":
                        {
                            ...
                            if (ivHeadRows[colID]["@hltype"] == "load") {
                                ...
                                if (_params != "") {
                                    var fullNavigationDataNew = baseLink + "" + hLinkData + "&istsivparamcache=true" + _hLinkType + _torecid + navigationData + dynNavTst + `&isDupTab=${callParentNew('isDuplicateTab')}`;
                                    if (_urlProp == "" && isPopup)
                                        _urlProp = "popup";
