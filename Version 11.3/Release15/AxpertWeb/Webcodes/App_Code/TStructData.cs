...
public class TStructData
{
    ...
    public string CallSaveDataWS(TStructData tstData, ArrayList fldArray, ArrayList fldDbRowNo, ArrayList fldValueArray, ArrayList fldDeletedArray, ArrayList deletedFldArrayValues, string files, string rid, string delRows, string changedRows, string axRulesFlds, string axPegApprovalSave)
    {
        ...
        if (!result.StartsWith(Constants.ERROR))
        {
            ...
            if (transid == "axrlr" || transid == "ad_re")//Delete tstruct cached keys for particular form On Save of AxRules
            {
                try
                {
                    XmlDocument xmlDoc = new XmlDocument();
    ...
    public string CallGetExcelImportValuesWS(TStructData tstData, ArrayList fldArray, ArrayList fldDbRowNo, ArrayList fldValueArray, ArrayList fldDeletedArray, string frameNo, string s)
    {
        DateTime stTime = DateTime.Now;
        string result = null;
        string dcNo = frameNo;
