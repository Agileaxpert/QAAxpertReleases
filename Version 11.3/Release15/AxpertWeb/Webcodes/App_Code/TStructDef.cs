        ...
        if ((btnNodes.Attributes["cat"] != null) && (btnNodes.Attributes["cat"].Value == "btn"))
        {
            ...
            if (dimension != string.Empty)
            {
                ...
                else if (task != "tasks")
                {
                    ...
                    if (string.IsNullOrEmpty(image))
                        btnHtml.Append("<div class=\"input-group\"><input type='button' value=\"" + caption + "\" class=\"tstformbutton btn btn-sm col-12 m-auto shadow-sm btn btn-white btn-color-gray-900 btn-active-primary\" title=\"" + hint + "\" " + btnFunction + "></div>");
                    else
    ...
    private string GetFullDCHtml(int dcNo, string fieldhtml, string isTab)
    {
        ...
        else
        {
            ...
            if (dcNo == dcs.Count)
            {
                ...
                ngBorder = "<div id=\"divDc" + dcNo + "\"  class='row mainIframe " + (((DcStruct)(dcs[dcNo - 1])).isgrid ? "" : "grid-stack gx-0") + " " + (((DcStruct)(dcs[dcNo - 1])).isgrid ? "" : dcBoolean) + "' > ";
            }
            else
            {
                ...
                {
                    if (((DcStruct)(dcs[dcNo - 1])).isgrid)
                        ngBorder = "<div id=\"divDc" + dcNo + "\"  class='row mainIframe " + (((DcStruct)(dcs[dcNo - 1])).isgrid ? "" : "grid-stack gx-0") + "' > ";
                    else
                    {
                        ...
                        {
                            if (EnableOldTheme == "true")
                                ngBorder = "<div id=\"divDc" + dcNo + "\"  class='row mainIframe " + (((DcStruct)(dcs[dcNo - 1])).isgrid ? "" : "grid-stack gx-0") + " " + dcBoolean + "' > ";
                            else
                                ngBorder = "<div id=\"divDc" + dcNo + "\" class='row mainIframe " + (((DcStruct)(dcs[dcNo - 1])).isgrid ? "" : "grid-stack gx-0") + " " + dcBoolean + "' > ";
    ...
    public string GetDCTabsDesign(string dcNo)
    {
        ...
        for (int j = 0; j < dcNos.Length; j++)
        {
            ...
            if (j == 0)
            {
                ...
                {
                    fieldhtml = GetFieldHtml(tabNo);
                    strGridHtml = "<div class='card card-xl-stretch mb-1 mb-xl-2 border border-gray-300 rounded-0 mainContent'>" + GetFullDCHtml(tabNo, fieldhtml, "true") + "</div>";
                }
                tabDCStatus.Add("1");
            }
            else
    ...
    private string GetInputHTML(FieldStruct fld, bool isGrid, string name, int fldNo, string[] fldTlhw, string width, string NumericCss, string popImg, string popHdnImg)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    inputHTML.Append(" " + fldCss + "  data-input title=\"" + defaultTimeStr + "\"  " + (isMobile ? " onfocus=\"blur()\" " : "") + " />");
        ...
        if (((DcStruct)(dcs[dcNo - 1])).isgrid)
        {
            ...
            else
            {
                ...
                if (((DcStruct)(dcs[dcNo - 1])).DcBlean != "" && ((DcStruct)(dcs[dcNo - 1])).DcBlean.ToUpper() == "TRUE")
                {
                    ...
                    fullGridHtml1 += "<li id=head" + dcNo + " class=\"nav-item d-flex p-3 shadow-sm bg-white rounded-top\">" + dcBooleanHtml + "<a class=\"fs-4 nav-link fw-boldest text-gray-900 rounded-0 border-0 active\" data-bs-toggle=\"tab\" aria-current=\"page\" href=\"javascript:void(0);\" onclick='javascript:ShowDc(\"" + dcNo + "\");'>" + ((DcStruct)(dcs[dcNo - 1])).caption + "</a></li></ul>";
                }
                else
                    fullGridHtml1 += "<li id=head" + dcNo + " class=\"nav-item d-flex p-3 shadow-sm bg-white rounded-top\"><a class=\"fw-bold fs-6 nav-link fw-boldest text-gray-800 rounded-0 border-0 active\" data-bs-toggle=\"tab\" aria-current=\"page\" href=\"javascript:void(0);\" onclick='javascript:ShowDc(\"" + dcNo + "\");'>" + ((DcStruct)(dcs[dcNo - 1])).caption + "</a></li></ul>";
            ...
            else
            {
                ...
                if (dcNo > 1)
                {
                    ...
                    if (((DcStruct)(dcs[dcNo - 1])).DcBlean != "" && ((DcStruct)(dcs[dcNo - 1])).DcBlean.ToUpper() == "TRUE")
                    {
                        ...
                        dcHtml.Append("<li id=head" + dcNo + " class=\"nav-item d-flex p-3 shadow-sm bg-white rounded-top\">" + dcBooleanHtml + "<a class=\"fs-4 nav-link fw-boldest text-gray-900 rounded-0 border-0 active\" data-bs-toggle=\"tab\" aria-current=\"page\" href=\"javascript:void(0);\" onclick='javascript:ShowDc(\"" + dcNo + "\");'>" + ((DcStruct)(dcs[dcNo - 1])).caption + "</a></li></ul>");
                    }
                    else
                        dcHtml.Append("<li id=head" + dcNo + " class=\"nav-item d-flex p-3 shadow-sm bg-white rounded-top\"><a class=\"fw-bold fs-6 nav-link fw-boldest text-gray-800 rounded-0 border-0 active\" data-bs-toggle=\"tab\" aria-current=\"page\" href=\"javascript:void(0);\" onclick='javascript:ShowDc(\"" + dcNo + "\");'>" + ((DcStruct)(dcs[dcNo - 1])).caption + "</a></li></ul>");
                }
