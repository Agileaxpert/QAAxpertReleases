...
<body class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled aside-fixed aside-default-enabled page-loading" id="dvadminconsole" data-kt-aside-minimize="off" dir="<%=direction%>">
