...
function updateAppLinkObj(url, forceUnBlock = 0, isSplitFrame = false, windowData = {}) {
    ...
    var blockHistory = ["mainnew.aspx", "ivtstload.aspx", "ivtoivload.aspx", "err.aspx", "adminconsole.aspx", "configurationStudio.aspx", "AutoComplete.aspx", "PluginCustomCode.aspx"];
