...
<body class="page-header-fixed" id="main_body" runat="server" dir="<%=direction%>">
        ...
        <div class="">
            <div class="">
                <form id="form1" runat="server">
                    ...
                    <div>
                        <h4>
                            <span>This page has been moved to <span style="font-weight: 900;">AxpertAdmin.aspx</span> page</span>
                        </h4>
                    </div>
                    <asp:Panel runat="server" ID="panelewConnection" CssClass="d-none">
                        <div class="configWrapper d-none">
                            <div class="">
    ...
    <script src="../Js/config.min.js?v=23" type="text/javascript"></script>
