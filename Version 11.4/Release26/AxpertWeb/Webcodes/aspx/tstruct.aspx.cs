...
public partial class Tstruct : System.Web.UI.Page
{
    ...
    private void WriteTstJsArrayDef(TStructDef strObj)
    {
        ...
        if (strObj.flds.Count > 0)
        {
            ...
            tstJsArrays.Append("var Expressions = new Array();var Formcontrols = new Array();var tstActionName=new Array();var actParRefresh=new Array();var actSaveTask=new Array();var PatternNames = new Array();var Patterns = new Array();var SFormControls=new Array();var SFCFldNames=new Array();var SFCApply=new Array();var SFCActionName=new Array();var actScriptTask=new Array();var actScriptCancel=new Array();var actScriptActive=new Array();var actScriptPushtoQueue=new Array();var SFCIsActive=new Array();var actScriptQueueName=new Array();");
                    ...
                    if (btn.action != "")
                    {
                        ...
                        if (!string.IsNullOrEmpty(btn.caption))
                        {
                            ...
                            else
                            {
                                ...
                                BtnHtml.Append("<a href=\"javascript:void(0)\" id='actbtn_" + id + "' " + btnFunction.ToString() + " alt='" + caption + "' title='" + caption + "' class=\"" + buttonClass + " caption menu-item px-3\"><span class='tbCaption menu-link px-3'>" + iconStyle + "<span class=\"text-truncate d-inline-block\">" + caption + "</span></span></a>");
                            }
                        }
                    }
                    else if (isDropDwn)
                    ...
                    if (isVisible == "true")
                    {
                        ...
                        if (isMobileView)
                        {
                            if (btnType == "classic")
                                ...
                                BtnHtml.Append("<div class=\"col-4\"><a href=\"javascript:void(0)\" id='" + id + "' " + btnFunction.ToString() + " alt='" + (caption == "" ? task : caption) + "' title='Delete' class=\"d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded p-3 mb-3\"><div class=\"symbol symbol-circle dropdownIconUI symbol-40px\"><span class=\"symbol-label bg-primary text-white fw-normal fs-3 iconUITitle mb-1\">" + strFirstChars + "</span></div><span class=\"dropdownIconName\">" + actBtnNames + "</span></a></div>");
                ...
                case "draft":
                    if (isVisible == "true")
                    {
                        ...
                        else
                        {
                            ...
                            modernToolbarBtnHtml.Append("<button type=\"button\" id=\"btnAppsDraft\" runat=\"server\" class=\"btn btn-icon btn-white btn-color-gray-600 btn-active-primary shadow-sm menu-dropdown\" data-kt-menu-trigger=\"click\" data-kt-menu-placement=\"bottom-end\" data-kt-menu-flip=\"top-end\">");
