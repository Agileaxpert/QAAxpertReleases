...
public partial class ParamsTstruct : System.Web.UI.Page
{
        ...
        for (int i = strObj.btns.Count - 1; i >= 0; i--)
        {
            ...
            switch (task)
            {
                ...
                case "listview":
                    ...
                    //btnStyle = "handCur";
                    //toolBarBtns.Add("<a href=\"javascript:void(0)\" id='listview' " + btnFunction.ToString() + " title='List View' class=\"btn btn-white btn-sm btn-color-gray-600 btn-active-primary shadow-sm me-2 d-none\">" + btnName + "</a>");
                    break;
        ...
        for (int i = 0; i < buttonList.Count; i++)
        {
            ...
            switch (task)
            {
                ...
                case "listview":
                    ...
                    //        BtnHtml.Append("<a href=\"javascript:void(0)\" id='" + id + "' " + btnFunction.ToString() + " alt='" + caption + "' title='" + caption + "' class=\"" + buttonClass + " btn btn-white btn-sm btn-color-gray-600 btn-active-primary shadow-sm me-2 d-none\">" + iconStyle + "<span class='tbCaption'>" + caption + "</span></a>");
                    //    }
                    //}
                    break;
        ...
        for (int i = 0; i < buttonList.Count; i++)
        {
            ...
            switch (task)
            {
                ...
                case "listview":
                    ...
                    //    btnFunction = " onclick=\"javascript:CallListView('" + transId + "');\" ";
                    //    if (isMobileView)
                    //        BtnHtml.Append("<div class=\"menu-item px-3 d-none\"><a href=\"javascript:void(0)\" id='" + id + "' " + btnFunction.ToString() + " alt='" + (caption == "" ? task : caption) + "' title='" + (caption == "" ? task : caption) + "' class=\"menu-link px-3\"><div class=\"symbol symbol-25px symbol-circle me-5 dropdownIconUI\"><span class=\"symbol-label bg-primary text-white fw-normal fs-3 iconUITitle\">" + strFirstChars + "</span></div><span class=\"dropdownIconName\">" + actBtnNames + "</span></a></div>");
                    //    else if (isFooter != "true")
                    //        modernToolbarBtnHtml.Append("<a id='" + id + "' " + btnFunction.ToString() + " title='" + (caption == "" ? task : caption) + "' href=\"javascript:void(0)\" class=\"btn btn-icon btn-white btn-color-gray-600 btn-active-primary shadow-sm me-2 d-none\"><span class=\"material-icons material-icons-style\">format_list_bulleted</span></a>");
                    //    else
                    //    {
                    //        footerbuttonList.Add("ftbtn_iList~" + id);
                    //        btnfooterlist = "javascript:CallListView('" + transId + "')";
