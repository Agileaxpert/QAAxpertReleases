var appUrl = "http://localhost:56647/"; // "https://app.buzzily.com/uat";
var axViewRecord;
var taskstatus
var armSessionId;
var taskjson;
...
class AxViewRecord {
    constructor() {
        ...
        <div class="row">
            <div class="col-md-12 pb-8 task-listing-card" data-process="{{processname}}" data-type="{{tasktype}}" data-taskid="{{taskid}}" data-transid="{{transid}}" data-keyvalue="{{keyvalue}}" >
                <h2 class="task-heading">
                    ...
                    <a href="javascript:void(0)" onclick="axViewRecord.openProcess('{{processname}}','{{keyfield}}','{{keyvalue}}','{{taskid}}')" title="{{displaytitle}}">
                ...
                <tr class="d-block">
                    ...
                    <td class="d-flex align-items-center task-name border-0">
                        <div class="d-flex flex-column">
                            <span class="List_view accordion-icon arrow{{taskid}}" onclick="axViewRecord.toggleTask('{{taskid}}')">
                                <span class="material-icons material-icons-style material-icons-2">chevron_right</span>
                            </span>
                            <input type="checkbox" value="" class="form-check-input task-list-checkbox">
                            <a href="javascript:void(0)" class="text-gray-800 fw-bold fs-6  mb-1 task-title" title="{{displaytitle}}"><span href="javascript:void(0)" onclick="axViewRecord.openProcess('{{processname}}','{{keyfield}}','{{keyvalue}}','{{taskid}}')">
        ...
        <div class="accordion accordion-icon-toggle task-process-selected" id="" data-process="{{processname}}">
            <div class="accordion-header py-3 d-flex collapsed sub-task-lists-wrap"
                ...
                <div class="  task_activity_content">
                    <div class="d-flex justify-content-center  " onclick="axViewRecord.filterTasks('process','{{processname}}',this)">
        ...
        <div class="step sub-task-lists " onclick="axViewRecord.filterTasks('type','{{processname}}~~{{type}}',this)">
            <div> <span
        ...
        this.filters.viewAllBtnHtml = `<!--<button class="task-activity-all btn btn-white" id="viewAllFilters" onclick="axViewRecord.viewAllFilters();" title="View All">View All</button>-->`;

        this.taskBtnsHtml = {};
        this.taskBtnsHtml.make = `
            <a href="javascript:void(0)" title="Make" class="btn btn-white btn-color-gray-700 btn-active-primary d-inline-flex align-items-center  btn-sm  me-2" onclick="axViewRecord.openProcess('{{processname}}','{{keyfield}}','{{keyvalue}}','{{taskid}}')""><span class="material-icons material-icons-style material-icons-2" style="color: orange;">assignment</span></a>`;
        this.taskBtnsHtml.view = `
            <a href="javascript:void(0)" title="View form" class="btn btn-white btn-color-gray-700 btn-active-primary d-inline-flex align-items-center  btn-sm  me-2 d-none" onclick="axViewRecord.openTstruct('{{transid}}','{{recordid}}','{{processname}}','{{keyvalue}}','{{taskname}}')"><span class="material-icons material-icons-style material-icons-2" style="color: darkmagenta;">visibility</span> View form
          
            
            </a>`;
        this.taskBtnsHtml.history = `
            <a href="javascript:void(0)" title="View History" class="btn btn-white btn-color-gray-700 btn-active-primary d-inline-flex align-items-center  btn-sm  me-2 d-none" onclick="axViewRecord.openHistory('{{processname}}','{{keyfield}}','{{keyvalue}}')""><span class="material-icons material-icons-style material-icons-2" style="color: blue;">history</span>View History
        ...
        <div class="task-actions-sets d-flex" data-taskname="{{taskname}}" data-processname="{{processname}}">
            ...
            <a href="javascript:void(0)" title="Approve"
                ...
                onclick="axViewRecord.doApprove('{{taskid}}', this);" data-confirmMessage='{{cmsg_appcheck}}'><span class="material-icons material-icons-style material-icons-2"
                ...
                <div class="card">
                    <div class="card-body py-5z">
                        ...
                        <div class="text-center Approval-OK">
                            <button class="btn btn-sm btn-primary shadow-sm" onclick="return axViewRecord.doApprove('{{taskid}}', this);" data-confirmMessage='{{cmsg_appcheck}}'>Approve</button>
                        </div>
                    </div>
                </div>
            </div>
...
`;
        ...
        <div class="task-actions-sets d-flex" data-taskname="{{taskname}}" data-processname="{{processname}}">
            <a href="javascript:void(0)" title="Reject"
                ...
                onclick="axViewRecord.doReject('{{taskid}}', this)" data-confirmMessage='{{cmsg_reject}}'><span class="material-icons material-icons-style material-icons-2"
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bolder w-400px Active_list_popover"
                ...
                <div class="card">
                    <div class="card-body py-5z">
                        ...
                        <div class="text-center Approval-OK">
                            <button class="btn btn-sm btn-primary shadow-sm" data-confirmMessage='{{cmsg_reject}}' onclick="return axViewRecord.doReject('{{taskid}}', this)">Reject</button>
                        </div>
                    </div>
                </div>
            </div>
...
`;
        ...
        <div class="task-actions-sets d-flex" data-taskname="{{taskname}}" data-processname="{{processname}}">
            <a href="javascript:void(0)" title="Return"
                class="btn btn-white btn-color-gray-700 btn-active-primary d-inline-flex align-items-center  me-2  btn-sm"
                onclick="axViewRecord.doReturn('{{taskid}}', this, '{{tasktype}}')" data-confirmMessage='{{cmsg_return}}'><span class="material-icons material-icons-style material-icons-2"
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bolder w-400px Active_list_popover"
                ...
                <div class="card">
                    <div class="card-body py-5z">
                        ...
                        <div class="text-center Approval-OK">
                            <button class="btn btn-sm btn-primary shadow-sm" data-confirmMessage='{{cmsg_return}}' onclick="return axViewRecord.doReturn('{{taskid}}', this, '{{tasktype}}')">Return</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        this.taskBtnsHtml.check = `
             <a href="javascript:void(0)" title="Check" class="btn btn-white btn-color-gray-700 btn-active-primary d-inline-flex align-items-center  me-2  btn-sm" onclick="axViewRecord.doCheck('{{taskid}}')">
        ...
        <li>
            <a href="javascript:void(0)" href="javascript:void(0)" title="Approve" data-confirmMessage='{{cmsg_appcheck}}' onclick="axViewRecord.doApprove('{{taskid}}', this);" class="mobile">
                    ...
                    <div class="card-body py-5z">
                        ...
                        <div class="text-center Approval-OK">
                            <button class="btn btn-sm btn-primary shadow-sm mobile"
                                onclick="return axViewRecord.doApprove('{{taskid}}', this);" data-confirmMessage='{{cmsg_appcheck}}'>Approve</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <li>
            <a href="javascript:void(0)" href="javascript:void(0)" title="Reject" data-confirmMessage='{{cmsg_reject}}' onclick="axViewRecord.doReject('{{taskid}}', this);" class="mobile">
                    ...
                    <div class="card-body py-5z">
                        ...
                        <div class="text-center Reject-OK">
                            <button class="btn btn-sm btn-primary shadow-sm mobile" data-confirmMessage='{{cmsg_reject}}'
                                onclick="return axViewRecord.doReject('{{taskid}}', this);">Reject</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <li>
            <a href="javascript:void(0)" href="javascript:void(0)" title="Return" data-confirmMessage='{{cmsg_return}}' onclick="axViewRecord.doReturn('{{taskid}}', this, '{{tasktype}}');" class="mobile">
                    ...
                    <div class="card-body py-5z">
                        ...
                        <div class="text-center Return-OK">
                            <button class="btn btn-sm btn-primary shadow-sm mobile" data-confirmMessage='{{cmsg_return}}'
                                onclick="return axViewRecord.doReturn('{{taskid}}', this, '{{tasktype}}');">Return</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <li>
            <a href="javascript:void(0)" title="Make" onclick="axViewRecord.openProcess('{{processname}}','{{keyfield}}','{{keyvalue}}','{{taskid}}')">
                <span class="material-icons material-icons-style material-icons-2">
        ...
        <li class='d-none'>
            <a href="javascript:void(0)" title="View Form" onclick="axViewRecord.openTstruct('{{transid}}','{{recordid}}','{{processname}}','{{keyvalue}}','{{taskname}}')">
        ...
        <li class='d-none'>
            <a href="javascript:void(0)" title="View History" onclick="axViewRecord.openHistory('{{processname}}','{{keyfield}}','{{keyvalue}}')"  style="color: blue;">
                <span class="material-icons material-icons-style material-icons-2">
        ...
        <li>
            <a href="javascript:void(0)" title="Check" onclick="axViewRecord.doCheck('{{taskid}}')"  style="color: blue;">
                <span class="material-icons material-icons-style material-icons-2">
    ...
    openTstructPage(transid, recordid) {
        
        let _this = this;
        _this.checkAxpertConnection();
        window.location.href = `${appUrl}/aspx/Axmain.aspx?mailapproval=true&authKey=AXPERT-${armSessionId}&pname=t${transid}&params=recordid~${recordid}^act~load`
    }
    ...
    checkComments(type, taskId, elem) {
        ...
        let taskProps = axViewRecord.dataSources.TaskReasons[taskId];
    ...
    constructFilters() {
        ...
        if (this.dataSources["Tasks"].length > 0) {
            var processWiseCounts = axViewRecord.dataSources["Tasks"].reduce((p, c) => {
            ...
            axViewRecord.dataSources["Tasks"].forEach((row) => {
    ...
    checkConfirmation(axViewRecord, action, taskId, taskType, elem) {
                ...
                buttons: {
                    buttonA: {
                        ...
                        action: function () {
                            ...
                            ShowDimmer(true);
                            axViewRecord.doTaskAction(action, taskId, taskType, elem);
                        }
                    },
                    buttonB: {
                        text: "No",
    ...
    bindEvents() {
        document.querySelectorAll(".taskActionBtn").forEach((item) => {
            KTMenu.getInstance(item).on("kt.menu.dropdown.show", function (item) {
                ...
                axViewRecord.checkPopoverConfirmation(itemData.action, itemData.taskid, item, itemData.confirmmessage);
            });
        });
    }
    ...
    <div id="kt_content_container" class="">
        ...
        <div class="d-flex align-items-center Activelist-Tools">
            ...
            <div id="" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-dismiss="click"
                ...
                <button type="button"
                    class="btn btn-icon btn-white btn-color-gray-600 btn-active-primary shadow-sm me-2 tb-btn btn-sm disabled"
                    onclick="axViewRecord.toggleFilters();">
            ...
            <div data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-dismiss="click"
                ...
                <button type="button" value="List" onclick="axViewRecord.toggleViews(this);"
            ...
            <div data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-dismiss="click"
                ...
                <button type="button" value="Card" onclick="axViewRecord.toggleViews(this);"
            ...
            <div class="col-xl-3 col-md-3 d-flex flex-column flex-column-fluid vh-100 min-vh-100 d-none"
                ...
                <div id="AllTask_Header" class="d-flex align-items-center task-process-selected">
                    <div class="d-flex justify-content-center  TotalTask-Wrap">
                        ...
                        <div class="all-tasks-container" onclick="axViewRecord.filterTasks('all','',this)">
...
function authenticationCheck() {
    ...
    passwordVerifyBtn.addEventListener('click', function () {
        ...
        if (passWordFieldVal !== '') {
            ...
            var action = 'Approve'
            var tempAction = urlParams.get('action') || "";
            try {
                $.ajax({
                    type: "POST",
                    url: '../../api/v1/ARMViewRecordDetails',
                    data: JSON.stringify({ TransId: transid, RecordId: recordid, UserId: userId, AppName: appName, Password: passWord, Action: action }),
                    cache: false,
                    async: false,
            ...
            if (armSessionId) {
                ...
                var transId = urlParams.get('transid');
                var recordId = urlParams.get('recordid');
                if (typeof transId != "undefined" && typeof recordId != "undefined") {
                    axViewRecord = new AxViewRecord();
                    axViewRecord.getUrlParams();
                    axViewRecord.openTstructPage(transId, recordId);
                }
                else {

                    showAlertDialog('error', 'Record details not found');
                    var shortMessageWrapper = document.querySelector('.shortMessageWrapper');
                    setTimeout(function () {
                        shortMessageWrapper.remove();
                    }, 2000);
...
function showTaskDetails() {
    axViewRecord = new AxViewRecord();
    axViewRecord.getUrlParams();
    axViewRecord.fetchProcessTask("Tasks");

    let _tasks = axViewRecord.task;
    if (axViewRecord.isNullOrEmpty(_tasks.taskName) || axViewRecord.isUndefined(_tasks.taskName)) {
        axViewRecord.fetchActiveTasks("Tasks");
        ...
        axViewRecord.fetchProcessTask("Tasks");
        if (!axViewRecord.isUndefined(axViewRecord.dataSources?.["Tasks"]?.[0]?.["displaytitle"])) {
            document.querySelector("#task-page-title").innerHTML = axViewRecord.dataSources["Tasks"][0]["displaytitle"];
        }
    }
    axViewRecord.showViews();
    axViewRecord.bindEvents();
