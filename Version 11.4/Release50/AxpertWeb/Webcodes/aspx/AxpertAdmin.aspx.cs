...
public partial class AxpertAdmin : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static string AppTestConnection(string ddldbtype, string ddldbversion, string ddldriver, string txtccname, string txtusername, string txtPassword, string txtpostgresodbc)
    {
    ...
    [WebMethod]
    public static string VerifyARMSettings(string proj, string aUrl)
    {
    ...
    [WebMethod]
    public static string ARMConnection(string aKey, string aUrl, string aScriptsUrl, string aPeg, string proj, string aExpiryMinutes, string aNotificationURL, string aNotificationExpiryHours, string aNotificationMaxPerUser)
    {
        string result = "";
        try
        {
    ...
    [WebMethod]
    public static string FileConnection(string fUpload, string fDownload, string proj, string fMapUsername, string fMapPwd, string AxAttachSize)
    {
        string result = "";
        try
        {
    ...
    public static string SaveSSOConnection(object requestJson, string ssoType, string ssoProj)
    {
        ...
        try
        {
            ...
            //fdwObj.HashDeletekeyNew(Constants.AX_COMMON_APPSETTING_KEY, Constants.AXSSO_CONN_KEY, ssoProj);
            fdwObj.HashDeleteAllkey(Constants.AX_COMMON_APPSETTING_KEY, ssoProj);
            HttpContext.Current.Session.Remove("AppAllSettingsKey-" + ssoProj);
        }
        catch (Exception ex) { }
        string ScriptsPathSSo = HttpContext.Current.Application["ScriptsPath"].ToString() + "ssoinfoconfig.ini";
