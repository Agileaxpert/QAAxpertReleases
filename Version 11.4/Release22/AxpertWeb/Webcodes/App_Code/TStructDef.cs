        ...
        foreach (XmlNode actionNode in actionNodes)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (isActButton)
                        actions.Add(act);
                    formcontrol.Append("tstActionName[" + actNo + "]= " + "\"" + act.actname + "\";actParRefresh[" + actNo + "]= " + "\"" + act.actParRefresh + "\";actSaveTask[" + actNo + "]= " + "\"" + act.actSaveTask + "\";actScriptTask[" + actNo + "]=" + "\"" + act.actScriptTask + "\";actScriptCancel[" + actNo + "]=\"" + act.actScriptCancel + "\";actScriptActive[" + actNo + "]=\"" + act.scriptActive + "\";actScriptPushtoQueue[" + actNo + "]=\"" + act.pushtoQueue + "\";");
