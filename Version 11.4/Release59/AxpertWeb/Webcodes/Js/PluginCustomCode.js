...
$(document).ready(function () {
    ...
    var pageToLoad = sessionStorage.getItem(
        "reloadPluginCustomPage"
    );
    if (pageToLoad) {
        ...
        setTimeout(function () {
            if (typeof _customPlugins !== "undefined" &&
                typeof _customPlugins.loadIvTstPage === "function") {
                _customPlugins.loadIvTstPage(pageToLoad);
            }
        }, 500);
    }
});
