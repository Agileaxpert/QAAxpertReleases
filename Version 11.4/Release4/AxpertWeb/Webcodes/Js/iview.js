...
function ClearParamValues() {
    ...
    if (document.title == "Iview" || document.title == "Listview") {
        ...
        if ($j("#hdnparamValues").val() != "") {
            ...
            const encryptedText = encryptor.encrypt($j("#hdnparamValues").val());
            if (!encryptedText) {
                $j("#hdnparamValues").val('');
            } else {
                $j("#hdnparamValues").val(encryptedText);
            }
        }
        ...
        if (isInValid) {
            ...
            if (typeof linkParams != "undefined" && linkParams != "") {
                ...
                if (!encryptedText) {
                    ...
                    $("#hdnparamValues").val(encryptedText);
                }
            }
...
function getNextDtRecords(pageNo) {
    ...
    if (paramX != "") {
        const encryptor = new JSEncrypt();
        encryptor.setPublicKey(rsaPublicKey);
        const encryptedText = encryptor.encrypt(paramX);
        if (!encryptedText) {
            paramX = "";
        } else {
            paramX = encryptedText;
        }
    }
