...
window.addEventListener('DOMContentLoaded', function () {
    ...
    //else if (localStorage.getItem('web_browser_dup-' + appSessUrl) == null) {
    //    alert('duplicate tab load2');
    //    isDuplicateTab = "true";
    //    localStorage.setItem('web_browser_dup-' + appSessUrl, 'true');
    //    // duplicate tab
    //    return;
    //} else {
    //    alert('duplicate tab load3');
    //    isDuplicateTab = "true";
    //    isMulDuplicateTab = "true";
    //    window.location.href = "../aspx/dupTab.html";
    //    return;
    //}
}, false);
...
function LoadIframe(src, isautoprocess = false) {
    setTimeout(function () {
        try {
            ...
            /*if (src != "" && _el.src != "" && originaltrIds.length > 0 && src.indexOf("tstruct.aspx?") > -1) {*/
            if (src != "" && src.indexOf("tstruct.aspx?") > -1) {
                ...
                if ((src.indexOf("&recordid=") > -1 || src.indexOf("?recordid=") > -1) && isdummyLoad != "true") {
                    src += "&dummyload=false";
...
function DoUtilitiesEvent(type) {
    switch (type) {
        case "Responsibilities":
            ...
            break;
        case "ImportData":
            let myImportModal = new BSModal("ImportData", "Import Data", "<iframe src='../aspx/ImportNew.aspx'  class='vw-100 vh-100' scrolling='no'></iframe>", () => {
                //shown callback
                $(".btn-close").focus();
                // $("#btnClose").hide()
            }, () => {
