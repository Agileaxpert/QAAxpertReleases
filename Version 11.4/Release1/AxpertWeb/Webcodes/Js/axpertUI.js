                ...
                menuConfiguration: {
                    ...
                    menuTemplete: {
                        menuUl: {
                            ...
                            dashBoard: `<a class="menu-icon d-none" href="javascript:void(0);" title="Dashboard">
                                                <span class="material-icons material-icons-style material-icons-2">
                                                   dashboard
                                                </span>
                                        </a>`,
                            calendar: `<a class="menu-icon d-none" href="javascript:void(0);" title="Calendar">
        ...
        cardsPage = {
            ...
            _setOptionsCardInfo(cardElement, cardData, card) {
                ...
                if(card?.cardbuttons?.btnoption?.length > 0){
                    ...
                    dropdownOptions.replaceWith($(`${
                        btnoption.map((btn, btnInd)=>`
                            ${btn?.Button ? `
