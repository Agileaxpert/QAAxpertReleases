...
public partial class iview : System.Web.UI.Page
{
    ...
    {
        if (IsPostBack && hdnparamValues.Value != "")
        {
            string encrypted = hdnparamValues.Value;
            string decrypted;
            try
            {
                using (RSA rsa = RSA.Create())
                {
                    rsa.FromXmlString(ViewState["xmlPrivateKey"].ToString());
        ...
        else
        {
            ...
            ViewState["xmlPrivateKey"] = rsa.ToXmlString(true);
