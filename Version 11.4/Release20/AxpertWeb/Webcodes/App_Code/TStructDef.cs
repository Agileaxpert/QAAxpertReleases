        ...
        if (isGrid)
        {
            ...
            if (fld.datatype.ToUpper() == "DATE/TIME")
            {
                if (fld.fldType != string.Empty && fld.fldType.ToLower() == "timestamp")
                {
                    ...
                    {
                        inputHTML.Append(fldHdnCss + " title=\"" + defaultDateTimeStr + "\"  " + (isMobile ? " onfocus=\"blur()\" " : "") + " value=\"" + defaultDateTimeStr + "\"/><span class=\"input-group-addon spanDateTime\"><i class=\"icon-basic-calendar\"></i></span></span>" + popHdnImg);
                    }
                }
                else
                {
            ...
            else if (fld.name.ToLower().StartsWith("axptm_") || fld.name.ToLower().StartsWith("axpdbtm_") || (fld.fldType != string.Empty && fld.fldType.ToLower() == "time"))
            {
                ...
                {
                    inputHTML.Append(fldHdnCss + " title=\"" + defaultTimeStr + "\" placeholder=\"" + is24Hour + "\" " + (isMobile ? " onfocus=\"blur()\" " : "") + " value=\"" + defaultTimeStr + "\"/><span class=\"input-group-addon spanTime\"><i class=\"glyphicon glyphicon-time\"></i></span></span>" + popHdnImg);
                }
