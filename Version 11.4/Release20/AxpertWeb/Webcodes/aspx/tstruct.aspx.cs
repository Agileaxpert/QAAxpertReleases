...
public partial class Tstruct : System.Web.UI.Page
{
    ...
    private void WriteTstJsArrayDef(TStructDef strObj)
    {
        ...
        if (strObj.flds.Count > 0)
        {
            ...
            tstJsArrays.Append("var Expressions = new Array();var Formcontrols = new Array();var tstActionName=new Array();var actParRefresh=new Array();var actSaveTask=new Array();var PatternNames = new Array();var Patterns = new Array();var SFormControls=new Array();var SFCFldNames=new Array();var SFCApply=new Array();var SFCActionName=new Array();var actScriptTask=new Array();var actScriptCancel=new Array();var actScriptActive=new Array();var actScriptPushtoQueue=new Array();");
