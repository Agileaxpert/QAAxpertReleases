        ...
        for (int i = strObj.btns.Count - 1; i >= 0; i--)
        {
            ...
            switch (task)
            {
                ...
                case "draft":
                    ...
                    toolBarBtns.Add("<div class=\"liTaskItems menu-item px-3\"><a href=\"javascript:void(0)\" id='DraftSave' onclick=\"SaveAsDraftNew();\" title='Save' class=\"TaskItems menu-link px-3\">Save</a></div>");
                    toolBarBtns.Add("<div class=\"liTaskItems menu-item px-3\"><a href=\"javascript:void(0)\" id='DraftLoad' onclick=\"getDraftsListNew(this);\" title='Load' class=\"TaskItems menu-link px-3\">Load</a></div>");
                    toolBarBtns.Add("</div>");
                    break;
