...
<head runat="server">
    ...
    <script type="text/javascript" src="../Js/tstruct.min.js?v=687"></script>
    <script type="text/javascript" src="../Js/helper.min.js?v=174"></script>
...
<body onload="ChangeDir('<%=direction%>');">
    <form id="form1" runat="server">
        <asp:ScriptManager ID="ScriptManager1" runat="server">
            <Scripts>
                <asp:ScriptReference Path="../Js/tstruct.min.js?v=687" />
            </Scripts>
            <Services>
    ...
    <script src="../Js/common.min.js?v=163"></script>
</body>
</html>
